            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                  image:    _authMod == AuthMod.SignUp
                      ? AssetImage(Assets.page2) : AssetImage(Assets.page1),
                  fit: BoxFit.cover,
                )),
            child: Padding(
                          ...
                          Row(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Text('haven\'t create a account yet?',style: TextStyle(color: Colors.black),),
                                  TextButton(
                                    child: Text(
                                      'Switch to ${_authMod == AuthMod.LogIn ? 'Sign up' : 'Sign in'}',
                                      style: TextStyle(color: Color(0XFFb75ef2)),
